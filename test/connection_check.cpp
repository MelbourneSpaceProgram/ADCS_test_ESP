...
void setup() {
    ...
    for (uint8_t i = 0; i < device_count; ++i) {
        ...
        if (c == MPU9150_WHOAMI_DEFAULT_VALUE) {
            Serial.println(" may be MPU9150 and ready to use");
        } else if (c == MPU9250_WHOAMI_DEFAULT_VALUE) {
            Serial.println(" may be MPU9250 and ready to use");
        } else if (c == MPU9255_WHOAMI_DEFAULT_VALUE) {
            Serial.println(" may be MPU9255 and ready to use");
        } else {
