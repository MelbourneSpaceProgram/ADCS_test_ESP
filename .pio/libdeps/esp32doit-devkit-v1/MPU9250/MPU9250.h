...
static constexpr uint8_t MPU9150_WHOAMI_DEFAULT_VALUE{0x68};
// static constexpr uint8_t MPU9150_WHOAMI_DEFAULT_VALUE{0x69};
...
using MPU9150 = MPU9250_<TwoWire, MPU9150_WHOAMI_DEFAULT_VALUE>;
